...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(name, companyname, city, contactno, website, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$city', '$contactno', '$website', '$email', '$password', '$aboutme', '$file')";
