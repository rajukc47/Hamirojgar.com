            ...
            <div class="row margin-top-20">
              ...
              <?php
               $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_company]' AND id_jobpost='$_GET[id]'";
                ...
                <hr>
                <div>
                  <p><i class="fa fa-calendar text-green"></i> Created Date : <?php echo date("d-M-Y", strtotime($row['createdat'])); ?> <i class="fa fa-calendar text-green"></i> Closing Date : <?php echo date("d-M-Y", strtotime($row['closingdate'])); ?></p>            
                </div>
                 <table class="table">
